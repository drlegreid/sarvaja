"""
Robot Framework Library for SessionCollector - Core Tests.

Per P4.2: Session Collector.
Split from SessionCollectorLibrary.py per DOC-SIZE-01-v1.

Covers: Unit tests, event/decision/task capture, serialization, dataclasses.
"""
import json
from robot.api.deco import keyword


class SessionCollectorCoreLibrary:
    """Library for testing SessionCollector core functionality."""
