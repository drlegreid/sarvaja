...
| **WORKFLOW-RD-02-v1** | R&D Workflow with Approval Gate | CRITICAL | ACTIVE | OPERATIONAL | [View](../leaf/WORKFLOW-RD-02-v1.md) |
...
- **WORKFLOW-RD-02-v1**: R&D impacting budget/architecture/strategy MUST require approval
