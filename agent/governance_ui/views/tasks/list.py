        ...
        with v3.VCardText(v_if="!is_loading"):
            v3.VDataTable(
                ...
                headers=[
                    ...
                    {"title": "Sessions", "key": "linked_sessions_count", "width": "80px",
                     "sortable": True},
                    {"title": "Created", "key": "created_at", "width": "110px", "sortable": True},
                    {"title": "Updated", "key": "completed_at", "width": "110px", "sortable": True},
                    {"title": "Gap", "key": "gap_id", "width": "110px", "sortable": True},
                ],
                item_value="task_id",
