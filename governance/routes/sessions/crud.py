...
async def list_sessions(
    ...
    Per GAP-EXPLOR-API-001: Returns pagination metadata consistent with /api/tasks.
    """
    try:
        ...
        # Return paginated response with metadata (per MCP-OUTPUT-01-v1)
        ...
        return PaginatedSessionResponse(
            items=[SessionResponse(**s) for s in paginated_sessions],
